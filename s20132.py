...
st.write('Najwyższa średnia ocena w zależności od rozmiaru aplikacji:', highest_avg_rating_size, ' MB z wartością:', highest_avg_rating_size_value)
st.write('Najniższa średnia ocena w zależności od rozmiaru aplikacji:', lowest_avg_rating_size, ' MB z wartością:', lowest_avg_rating_size_value)
...
st.write('Najwyższa średnia ocena przy cenie:', highest_avg_rating_price, ' USD z wartością:', highest_avg_rating_price_value)
st.write('Najniższa średnia ocena przy cenie:', lowest_avg_rating_price, ' USD z wartością:', lowest_avg_rating_price_value)
...
plt.title('Zależność między wersją Androida a oceną aplikacji')
